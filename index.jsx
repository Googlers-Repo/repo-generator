...
export default () => {
  ...
  const handleGenerate = React.useCallback(() => {
    ...
    const canExecuteZip = zip.interface.v2(zip.getPath()).canTypeMethod(2);
      ...
      >
        {Object.entries(values).map((entries) => {
          ...
          switch (typeof value) {
            ...
            default:
              return <TextField id={key} type={typeof value} label={key} value={values[key]} onChange={handleChange} fullWidth />;
          }
        })}
      </Stack>
    </Page>
